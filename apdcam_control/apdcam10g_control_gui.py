...
class APDCAM10G_GUI_class:
    ...
    def APDCAM_on(self):
        ...
        for i in range(10) :
            ...
            legyen az _in _out az apdcam10_control-bol
    ...
    # presumablyu the hv enable/disable functions are ipmlemented as well. Comment it here. 
                
    # These function have been implemented in APDCAM10G_control as well.                 
