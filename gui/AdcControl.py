...
class Adc(QWidget):
    ...
    def __init__(self,parent,number):
        ...
        g = QVGroupBox(self)
        l.addWidget(g)
        self.pllLocked = QCheckBox()
        self.pllLocked.setText("PLL Locked")
        g.addWidget(self.pllLocked)
        self.internalTrigger = QCheckBox()
        self.internalTrigger.setText("Int. trigger")
        g.addWidget(self.internalTrigger)
        self.overload = QCheckBox()
        self.overload.setText("Overload")
        g.addWidget(self.overload)
        self.led1 = QCheckBox()
        self.led1.setText("LED 1")
        g.addWidget(self.led1)
        self.led2 = QCheckBox()
        self.led2.setText("LED 2")
        ...
        self.reverseBitOrder = QCheckBox()
        self.reverseBitOrder.setText("Rev. bitord.")
        ...
        self.internalFilterDiv = QDoubleEdit()
